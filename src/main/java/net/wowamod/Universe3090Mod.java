...
import net.wowamod.init.Universe3090ModVillagerProfessions;
...
@Mod("universe3090")
public class Universe3090Mod {
	public static final Logger LOGGER = LogManager.getLogger(Universe3090Mod.class);
	public static final String MODID = "universe3090";

	public Universe3090Mod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		Universe3090ModSounds.REGISTRY.register(bus);
		Universe3090ModBlocks.REGISTRY.register(bus);
		Universe3090ModBlockEntities.REGISTRY.register(bus);
		Universe3090ModItems.REGISTRY.register(bus);
		Universe3090ModEntities.REGISTRY.register(bus);

		Universe3090ModTabs.REGISTRY.register(bus);
		...
		Universe3090ModFluids.REGISTRY.register(bus);
		Universe3090ModFluidTypes.REGISTRY.register(bus);
	}
