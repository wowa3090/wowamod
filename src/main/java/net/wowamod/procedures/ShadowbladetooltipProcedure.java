	...
	private static void execute(@Nullable Event event, Entity entity, ItemStack itemstack, List<Component> tooltip) {
		...
		if (itemstack.getItem() == Universe3090ModItems.SHADOWBLADE.get()) {
			tooltip.add(Component.literal(("\u00A77" + "\u041D\u0430\u043D\u043E\u0441\u0438\u0442 " + "\u00A7c"
					+ new java.text.DecimalFormat("####.##").format((entity.getCapability(Universe3090ModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new Universe3090ModVariables.PlayerVariables())).wowaswordupgrade / 25) + "\u00A77"
