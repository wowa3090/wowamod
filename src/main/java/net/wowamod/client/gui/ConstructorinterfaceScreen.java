...
public class ConstructorinterfaceScreen extends AbstractContainerScreen<ConstructorinterfaceMenu> {
	private final static HashMap<String, Object> guistate = ConstructorinterfaceMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ConstructorinterfaceScreen(ConstructorinterfaceMenu container, Inventory inventory, Component text) {
