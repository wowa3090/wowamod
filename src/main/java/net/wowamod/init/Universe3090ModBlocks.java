...
import net.wowamod.block.Redstone9xEnergizedBlock;
...
import net.wowamod.block.ExtractredsoulfluidBlock;
import net.wowamod.block.ExtractorBlock;
import net.wowamod.block.ExtractgolubaysoulBlock;
import net.wowamod.block.ExtractYellowSoulFluidBlock;
import net.wowamod.block.ExtractPurpleSoulFluidBlock;
import net.wowamod.block.ExtractOrangeSoulFluidBlock;
import net.wowamod.block.ExtractGreenSoulFluidBlock;
import net.wowamod.block.ExtractBlueSoulFluidBlock;
...
public class Universe3090ModBlocks {
	...
	public static final RegistryObject<Block> EXTRACTREDSOULFLUID = REGISTRY.register("extractredsoulfluid", () -> new ExtractredsoulfluidBlock());
	public static final RegistryObject<Block> EXTRACT_ORANGE_SOUL_FLUID = REGISTRY.register("extract_orange_soul_fluid", () -> new ExtractOrangeSoulFluidBlock());
	public static final RegistryObject<Block> EXTRACT_YELLOW_SOUL_FLUID = REGISTRY.register("extract_yellow_soul_fluid", () -> new ExtractYellowSoulFluidBlock());
	public static final RegistryObject<Block> EXTRACT_GREEN_SOUL_FLUID = REGISTRY.register("extract_green_soul_fluid", () -> new ExtractGreenSoulFluidBlock());
	...
	public static final RegistryObject<Block> EXTRACT_BLUE_SOUL_FLUID = REGISTRY.register("extract_blue_soul_fluid", () -> new ExtractBlueSoulFluidBlock());
	public static final RegistryObject<Block> EXTRACT_PURPLE_SOUL_FLUID = REGISTRY.register("extract_purple_soul_fluid", () -> new ExtractPurpleSoulFluidBlock());
