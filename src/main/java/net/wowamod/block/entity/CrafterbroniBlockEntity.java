...
public class CrafterbroniBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public Component getDefaultName() {
		return Component.literal("crafterbroni");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new WowabronyacraftringMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

	@Override
	public Component getDisplayName() {
		return Component.literal("Необычный Механизм");
	}
