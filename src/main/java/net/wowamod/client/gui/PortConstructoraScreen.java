...
public class PortConstructoraScreen extends AbstractContainerScreen<PortConstructoraMenu> {
	private final static HashMap<String, Object> guistate = PortConstructoraMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public PortConstructoraScreen(PortConstructoraMenu container, Inventory inventory, Component text) {
