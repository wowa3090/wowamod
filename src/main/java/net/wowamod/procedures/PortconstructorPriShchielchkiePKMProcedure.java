...
public class PortconstructorPriShchielchkiePKMProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((world.getBlockState(BlockPos.containing(x + 1, y, z))).getBlock() == WowamodModBlocks.REDSTONECOMMANDBLOCK.get() || (world.getBlockState(BlockPos.containing(x - 1, y, z))).getBlock() == WowamodModBlocks.REDSTONECOMMANDBLOCK.get()
				...
				|| (world.getBlockState(BlockPos.containing(x, y, z - 1))).getBlock() == WowamodModBlocks.REDSTONECOMMANDBLOCK.get()) {
			if ((world.getBlockState(BlockPos.containing(x + 1, y, z + 1))).getBlock() == WowamodModBlocks.INTERFACECONSTRUCTOR.get()
					|| (world.getBlockState(BlockPos.containing(x - 1, y, z - 1))).getBlock() == WowamodModBlocks.INTERFACECONSTRUCTOR.get()
					|| (world.getBlockState(BlockPos.containing(x - 1, y, z + 1))).getBlock() == WowamodModBlocks.INTERFACECONSTRUCTOR.get()
					|| (world.getBlockState(BlockPos.containing(x + 1, y, z - 1))).getBlock() == WowamodModBlocks.INTERFACECONSTRUCTOR.get()
					|| (world.getBlockState(BlockPos.containing(x, y, z + 2))).getBlock() == WowamodModBlocks.INTERFACECONSTRUCTOR.get()
					|| (world.getBlockState(BlockPos.containing(x, y, z - 2))).getBlock() == WowamodModBlocks.INTERFACECONSTRUCTOR.get()
					|| (world.getBlockState(BlockPos.containing(x - 2, y, z))).getBlock() == WowamodModBlocks.INTERFACECONSTRUCTOR.get()
					|| (world.getBlockState(BlockPos.containing(x + 2, y, z))).getBlock() == WowamodModBlocks.INTERFACECONSTRUCTOR.get()) {
