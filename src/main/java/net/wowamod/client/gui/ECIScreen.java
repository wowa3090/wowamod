...
public class ECIScreen extends AbstractContainerScreen<ECIMenu> {
	private final static HashMap<String, Object> guistate = ECIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ECIScreen(ECIMenu container, Inventory inventory, Component text) {
