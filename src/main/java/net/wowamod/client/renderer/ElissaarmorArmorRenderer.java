...
import net.wowamod.item.model.ElissaarmorModel;
...
public class ElissaarmorArmorRenderer extends GeoArmorRenderer<ElissaarmorItem> {
	public ElissaarmorArmorRenderer() {
		super(new ElissaarmorModel());
	...
	@Override
	public RenderType getRenderType(ElissaarmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
