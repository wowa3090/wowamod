...
public class Universe3090ModTabs {
	...
	public static final RegistryObject<CreativeModeTab> WOWAMODVKLADKA = REGISTRY.register("wowamodvkladka",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.universe3090.wowamodvkladka")).icon(() -> new ItemStack(Universe3090ModItems.WOWABRONYA_HELMET.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(Universe3090ModItems.DARKIRONFIXERS.get());
				...
				tabData.accept(Universe3090ModBlocks.REDSTONE_9X_ENERGIZED.get().asItem());
				...
				tabData.accept(Universe3090ModItems.LASER_LENS_MODULE.get());
				...
				tabData.accept(Universe3090ModItems.EXTRACTREDSOULFLUID_BUCKET.get());
				tabData.accept(Universe3090ModItems.EXTRACT_ORANGE_SOUL_FLUID_BUCKET.get());
				tabData.accept(Universe3090ModItems.EXTRACT_YELLOW_SOUL_FLUID_BUCKET.get());
				tabData.accept(Universe3090ModItems.EXTRACT_GREEN_SOUL_FLUID_BUCKET.get());
				tabData.accept(Universe3090ModItems.EXTRACTGOLUBAYSOUL_BUCKET.get());
				tabData.accept(Universe3090ModItems.EXTRACT_BLUE_SOUL_FLUID_BUCKET.get());
				tabData.accept(Universe3090ModItems.EXTRACT_PURPLE_SOUL_FLUID_BUCKET.get());
