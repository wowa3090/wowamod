...
import net.wowamod.item.WirelessModuleItem;
...
import net.wowamod.item.TheCoreOfTheSphereRedstoneItem;
import net.wowamod.item.TheCoreOfTheSphereItem;
import net.wowamod.item.SuperpalkaItem;
import net.wowamod.item.StabilizerItem;
...
import net.wowamod.item.MagicironplateItem;
...
import net.wowamod.item.LaserLensModuleItem;
...
import net.wowamod.item.IronSphereItem;
...
import net.wowamod.item.ExtractredsoulfluidItem;
...
import net.wowamod.item.ExtractYellowSoulFluidItem;
import net.wowamod.item.ExtractPurpleSoulItem;
import net.wowamod.item.ExtractPurpleSoulFluidItem;
import net.wowamod.item.ExtractOrangeSoulFluidItem;
import net.wowamod.item.ExtractGreenSoulItem;
import net.wowamod.item.ExtractGreenSoulFluidItem;
import net.wowamod.item.ExtractBlueSoulFluidItem;
...
import net.wowamod.item.EnergyModuleItem;
import net.wowamod.item.EmeraldswordItem;
import net.wowamod.item.EmeraldspickaxeItem;
import net.wowamod.item.EmeraldShovelItem;
import net.wowamod.item.EmeraldAxeItem;
...
import net.wowamod.item.DarkironfixersItem;
...
public class Universe3090ModItems {
	...
	public static final RegistryObject<Item> DARKIRONFIXERS = REGISTRY.register("darkironfixers", () -> new DarkironfixersItem());
	...
	public static final RegistryObject<Item> REDSTONE_9X_ENERGIZED = block(Universe3090ModBlocks.REDSTONE_9X_ENERGIZED);
	...
	public static final RegistryObject<Item> IRON_SPHERE = REGISTRY.register("iron_sphere", () -> new IronSphereItem());
	public static final RegistryObject<Item> THE_CORE_OF_THE_SPHERE = REGISTRY.register("the_core_of_the_sphere", () -> new TheCoreOfTheSphereItem());
	public static final RegistryObject<Item> THE_CORE_OF_THE_SPHERE_REDSTONE = REGISTRY.register("the_core_of_the_sphere_redstone", () -> new TheCoreOfTheSphereRedstoneItem());
	public static final RegistryObject<Item> ENERGY_MODULE = REGISTRY.register("energy_module", () -> new EnergyModuleItem());
	public static final RegistryObject<Item> WIRELESS_MODULE = REGISTRY.register("wireless_module", () -> new WirelessModuleItem());
	public static final RegistryObject<Item> LASER_LENS_MODULE = REGISTRY.register("laser_lens_module", () -> new LaserLensModuleItem());
	public static final RegistryObject<Item> UNCOMMON_DARK_CASE = block(Universe3090ModBlocks.UNCOMMON_DARK_CASE);
	...
	public static final RegistryObject<Item> EXTRACTREDSOULFLUID_BUCKET = REGISTRY.register("extractredsoulfluid_bucket", () -> new ExtractredsoulfluidItem());
	public static final RegistryObject<Item> EXTRACT_ORANGE_SOUL_FLUID_BUCKET = REGISTRY.register("extract_orange_soul_fluid_bucket", () -> new ExtractOrangeSoulFluidItem());
	public static final RegistryObject<Item> EXTRACT_YELLOW_SOUL_FLUID_BUCKET = REGISTRY.register("extract_yellow_soul_fluid_bucket", () -> new ExtractYellowSoulFluidItem());
	public static final RegistryObject<Item> EXTRACT_GREEN_SOUL_FLUID_BUCKET = REGISTRY.register("extract_green_soul_fluid_bucket", () -> new ExtractGreenSoulFluidItem());
	...
	public static final RegistryObject<Item> EXTRACT_BLUE_SOUL_FLUID_BUCKET = REGISTRY.register("extract_blue_soul_fluid_bucket", () -> new ExtractBlueSoulFluidItem());
	public static final RegistryObject<Item> EXTRACT_PURPLE_SOUL_FLUID_BUCKET = REGISTRY.register("extract_purple_soul_fluid_bucket", () -> new ExtractPurpleSoulFluidItem());
