	...
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (world instanceof Level _lvl4 && _lvl4.isDay() && world.canSeeSkyFromBelowWater(BlockPos.containing(x, y, z))) {
			if (new Object() {
				...
				}.receiveEnergySimulate(world, BlockPos.containing(x, y - 1, z), (int) (7 * multiplayer));
				{
				...
				}.receiveEnergySimulate(world, BlockPos.containing(x, y, z), (int) (7 * multiplayer));
				{
			...
			if (new Object() {
				...
				}.receiveEnergySimulate(world, BlockPos.containing(x, y - 1, z), (int) (5 * multiplayer));
				{
					BlockEntity _ent = world.getBlockEntity(BlockPos.containing(x, y - 1, z));
					int _amount = (int) energy;
					if (_ent != null)
				...
				}.receiveEnergySimulate(world, BlockPos.containing(x, y, z), (int) (5 * multiplayer));
				{
					BlockEntity _ent = world.getBlockEntity(BlockPos.containing(x, y, z));
					int _amount = (int) energy;
					if (_ent != null)
